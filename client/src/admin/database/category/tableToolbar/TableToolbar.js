...
export const TableToolbar = (props) => {
    ...
    const onSubmit = async (event) => {
        ...
        const response = await fetch(`${api}/category/action?updateString=${value}&ids=${JSON.stringify(selected)}`, {
            method: 'GET',
            headers: {
                    ...
                    <div className="search-bar-toolbar1">
                        <FormControl variant="standard" style={{ width: '100%' }}>
                            ...
                            >
                                ...
                                <MenuItem value={'comingSoon_true'}>Mark Coming soon</MenuItem>
                                <MenuItem value={'comingSoon_false'}>Unmark Coming soon</MenuItem>
                                <MenuItem value={'homePage_true'}>Display on Home page</MenuItem>
                                <MenuItem value={'homePage_false'}>Hide on Home page</MenuItem>
                                <MenuItem value={'ourStoryPage_true'}>Display on Our story page</MenuItem>
                                <MenuItem value={'ourStoryPage_false'}>Hide on Our story page</MenuItem>
                            </Select>
                        </FormControl>
